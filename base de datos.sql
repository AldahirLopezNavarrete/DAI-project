...
(num_clien int primary key identity (1,1) not null, -- Auto numeración primary key
Nombre_Clien varchar (40), 
RFC_Clien varchar (13),
Correo_Clien varchar (50),
Tel_Clien varchar(12)) -- 10 dígitos + código de país 2 
...
ya que asistimos a una tienda y el servicio de la persona que nos atendió fue muy malo,
además de que tardó mucho tiempo',12)
insert into Propuestas values
('Es necesario realizar una mejora en la calidad del algodón que usan en su ropa',12)
